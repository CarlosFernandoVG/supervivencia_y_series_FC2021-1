...
Realice la prueba generalizada de Wilcoxon de acuerdo a los datos del ejempo de la sección anterior.
...
Para realizar la prueba, denotemos $d_{j}$ el vector de fallas al tiempo $t_j$, $j=1,...,m$ con vector de medias $\mathbb{E}(d_j)$ y matriz de varianzas[^9.3] y covarianzas:

$$
Var(d_{ij}) = \frac{n_{1j}\cdot n_{2j}\cdot d_j(n_j-d_j)}{n_j^2(n_j-1)}
$$
